...
list_users = [{"username": "1", "walkfast": 5, "widthrange": 5, "current_position_on_map_x": 159, "current_position_on_map_y": 80},{"username": "2", "walkfast": 5, "widthrange": 5, "current_postion_on_map_x": 100, "current_position_on_map_x": 50},{"username": "3", "walkfast": 5, "widthrange": 5, "current_postion_on_map_x": 40, "current_postion_on_map_y": 30}]
...
def each_user(user_item, list_exits):
  start = (user_item[current_postion_on_map_x], user_item[current_postion_on_map_y])
  index = 0
  step = []
  for i in list_exits:
